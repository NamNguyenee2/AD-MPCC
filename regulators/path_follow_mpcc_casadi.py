...
class STMPCCPlannerCasadi:
    ...
    def plan(self, states, param, waypoints=None):
        ...
        u, mpc_ref_path_x, mpc_ref_path_y, mpc_pred_x, mpc_pred_y, done = self.MPCC_Control(states, param)
    ...
    def MPCC_Control(self, x0_full, param):
        ...
        input_o, states_output, theta_output, done = self.mpc_prob_solve(x0, self.u_his, param)
